/* ValidacionPersonalizada Prototype:
	...
	-Realiza las comprobacines de validez y envía comentarios al front-end.
*/
...
var passwordRepeatverificarValidez = [
	{
		...
		mensajeInvalido: 'Esta cnotraseña debe coinsidir con la primera.'
	}
];
/*
...
var usernameInput = document.getElementById('username');
var passwordInput = document.getElementById('password');
var repartirPasswordInput = document.getElementById('password_repeat');

usernnameInput.ValidacionPersonalizada = new ValidacionPersonalizada(usernameInput);
...
passwordInput.ValidacionPersonalizada.verValidez = passworderificarValidez;

repartirPasswordInput.ValidacionPersonalizada = new ValidacionPersonalizada(repartirPasswordInput);
repartirPasswordInput.ValidacionPersonalizada.verificarValidez = passwordRepeatverificarValidez
